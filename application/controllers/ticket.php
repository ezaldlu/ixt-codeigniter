...
function __construct(){
       ...
       <strong><span class='glyphicon glyphicon-remove-sign'></span></strong> Please Login First.
       </div>");
        redirect('login');
        }
 	...
 	if ($this->db->trans_status() === FALSE)
			{
			    ...
			    <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
			    <svg class='glyph stroked empty-message'><use xlink:href='#stroked-empty-message'></use></svg> Failed to Retrieve Datan.
			    </div>");
			...
			} else 
			{
			    ...
			    <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
			    <svg class='glyph stroked empty-message'><use xlink:href='#stroked-empty-message'></use></svg> Saved.
			    </div>");
				redirect('myticket/myticket_list');		
			}
