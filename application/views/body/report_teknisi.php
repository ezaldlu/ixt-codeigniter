...
<li class="active">Technician Reports</li>
</ol>
</div><!--/.row-->
...
<a href="<?php echo base_url();?>dashboard_teknisi/teknisi_view" style="text-decoration:none">Technician Reports <a href="<?php echo base_url();?>dashboard_teknisi/pdfreportteknisi/<?php echo $id_teknisi;?>" class="btn btn-danger" target="_blank">Pdf</a></a></div>
