...
<li class="active">Technician Progress</li>
</ol>
</div><!--/.row-->
...
<b>
  ...
  CLOSED DATE : <span class="label label-primary"><?php echo $tanggal;?></span></b>
...
<a href="#" class="list-group-item">
<b>
<?php if($tanggal_proses == "0000-00-00 00:00:00") { echo "NOT YET PROCESSED"; }
else
{?>
...
<div class="panel panel-danger">
  <div class="panel-heading">TRACKING TICKET</div>
  <div class="panel-body">
