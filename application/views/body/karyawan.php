...
<a href="<?php echo base_url();?>karyawan/add" style="text-decoration:none">Add New Employee</a></div>
					<div class="panel-body">
						<table data-toggle="table" data-show-refresh="false" data-show-toggle="true" data-show-columns="true" data-search="true"  data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    ...
						    <tr>
						        ...
						        <th data-field="departemen" data-sortable="true">Departement</th>
						        <th data-field="bagian" data-sortable="true">Division</th>
						        <th data-field="jabatan" data-sortable="true">Job Role</th>
						        <th>Action</th>
						    </tr>
                            </thead>
                            <tbody>
