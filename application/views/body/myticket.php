						...
						<table data-toggle="table" data-show-refresh="false" data-show-toggle="true" data-show-columns="true" data-search="true"  data-pagination="true" data-sort-name="name" data-sort-order="desc">
                           ...
                           <?php $no = 0; foreach($datamyticket as $row) : $no++;?>
						     <tr>
						        ...
						        else if($row->status==3) { echo "WAITING TECHNICIAN APPROVAL";}
...
<a title="Hapus Kontak" class="hapus btn btn-danger btn-xs" href="<?php echo base_url();?>myticket/feedback_no/<?php echo $row->id_ticket;?>/<?php echo $row->id_teknisi;?>"><span class="glyphicon glyphicon-thumbs-down"></span></a>
		...
		<div class="alert bg-warning" role="alert">
					<svg class="glyph stroked flag"><use xlink:href="#stroked-flag"></use></svg> Give Feeedback According to Technician Performance <a href="#" class="pull-right"><span class="glyphicon glyphicon-remove"></span></a>
				</div>	
